...
//	Matriz de Adjacencia
		...
		switch(criteria){
			...
			case 2:				
				...
				No ttt = determCam(mapaVert, caminho, map, path, path_index);
				rota2(map, ttt, path, path_index);
				break;
			case 3:
...
//			System.out.println("u " + u);
	...
	public static No determCam(int[][] mapaVert, LinkedList<Integer> caminho, Map map, int[] path, int path_index){
